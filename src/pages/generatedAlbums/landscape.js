  ...
  query landscapeQuery {
    allFile(
      filter: {
        ...
        relativeDirectory: { eq: "generatedAlbums/landscape" }
        ext: { eq: ".jpg" }
      }
    ) {
      edges {
      ...
      file(sourceInstanceName: {eq: "images"}, relativePath: {eq: "generatedAlbums/landscape/background.jpg"}) {
    childImageSharp {
      fluid(maxWidth: 4000) {
        ...GatsbyImageSharpFluid
      }
...
const landscape = ({ data }) => {
  ...
  return (
    <GalleryLayout title="landscape" heroImage={heroImage}>
      <p>
        <span>
