  ...
  query doggoQuery {
    allFile(
      filter: {
        ...
        relativeDirectory: { eq: "generatedAlbums/doggo" }
        ext: { eq: ".jpg" }
      }
    ) {
      edges {
      ...
      file(sourceInstanceName: {eq: "images"}, relativePath: {eq: "generatedAlbums/doggo/background.jpg"}) {
    childImageSharp {
      fluid(maxWidth: 4000) {
        ...GatsbyImageSharpFluid
      }
...
const doggo = ({ data }) => {
  ...
  return (
    <GalleryLayout title="doggo" heroImage={heroImage}>
      <p>
        <span>
