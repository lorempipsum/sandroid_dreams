...
export const query = graphql`
  query Open_Shutter_1Query {
    allFile(
      filter: {
        sourceInstanceName: { eq: "images" }
        relativeDirectory: { eq: "generatedAlbums/Open_Shutter_1" }
        ext: { eq: ".jpg" }
      }
    ) {
      edges {
      ...
      file(sourceInstanceName: {eq: "images"}, relativePath: {eq: "generatedAlbums/Open_Shutter_1/background.jpg"}) {
    childImageSharp {
      fluid(maxWidth: 4000) {
        ...GatsbyImageSharpFluid
      }
