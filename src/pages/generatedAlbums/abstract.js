  ...
  query abstractQuery {
    allFile(
      filter: {
        ...
        relativeDirectory: { eq: "generatedAlbums/abstract" }
        ext: { eq: ".jpg" }
      }
    ) {
      edges {
      ...
      file(sourceInstanceName: {eq: "images"}, relativePath: {eq: "generatedAlbums/abstract/background.jpg"}) {
    childImageSharp {
      fluid(maxWidth: 4000) {
        ...GatsbyImageSharpFluid
      }
...
const abstract = ({ data }) => {
  ...
  return (
    <GalleryLayout title="abstract" heroImage={heroImage}>
      <p>
        <span>
