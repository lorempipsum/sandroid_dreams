  ...
  query headshotsQuery {
    allFile(
      filter: {
        ...
        relativeDirectory: { eq: "generatedAlbums/headshots" }
        ext: { eq: ".jpg" }
      }
    ) {
      edges {
      ...
      file(sourceInstanceName: {eq: "images"}, relativePath: {eq: "generatedAlbums/headshots/background.jpg"}) {
    childImageSharp {
      fluid(maxWidth: 4000) {
        ...GatsbyImageSharpFluid
      }
...
const headshots = ({ data }) => {
  ...
  return (
    <GalleryLayout title="headshots" heroImage={heroImage}>
      <p>
        <span>
